...
syn match odinBuiltinType "\(i\(nt\|8\|16\|32\|64\|128\)\|uint\|u\(8\|16\|32\|64\|128\)\|f\(32\|64\)\|rawptr\|string\|byte\|rune\|struct\|union\|any\|type\)"
...
syn region odinContainerTypeParens contained start="\((\|{\)" skip="\((.\{-})\|{.\{-}}\)" end="\()\|}\)" contains=odinTypeAssignment skipwhite
syn region odinTypeTuple contained start="(" skip="(.\{-})" end=")" contains=odinTypeAssignment

" Functions
syn match odinFunction "[a-z_][a-zA-Z_]*(\@="
syn match odinFunctionDeclaration "\(^\s*\)\@<=[a-z_][a-zA-Z_]*\(\s*::\s*proc\)\@=" nextgroup=odinFuncTypeDec skipwhite
